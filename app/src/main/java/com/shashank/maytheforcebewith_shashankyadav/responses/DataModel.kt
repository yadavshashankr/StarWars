package com.shashank.maytheforcebewith_shashankyadav.responses

import java.io.Serializable


data class Percentage(
    var percentPeople: Int?, var percentPlanet: Int?, var percentFilms: Int?,
...
data class People1(
    ...
    var next: String?,
    var previous: String?,
    var results: ArrayList<Results1>?
)
...
data class Results1(
    var name: String = "N/A", var created: String = "N/A",
    ...
    var language: String = "N/A", var model:  String = "NA",
    var manufacturer: String = "NA", var cost_in_credits: String = "NA",
